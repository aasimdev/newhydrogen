<?php
$GLOBALS['title'] = "NewHydrogen | BioSolar Announces $5.0 Million Private Placement Offering";
$GLOBALS['desc'] = "";
$GLOBALS['keywords'] = "";
include('header.php'); ?>
...
<div class="subpages_frame text-center">
    <div class="container">
        <h1>BioSolar Announces $5.0 Million Private Placement Offering</h1>
    </div>
</div>
<div class="inner_page single_pagee">
    <div class="container">
